...
def derive_cable_gland_certification(
    ...
    Since there is no standalone "area classification" field, we
    inspect ``positioner_certification`` which is copied from the
    enquiry's area classification row.  If that field mentions a
    Zone, we derive the cable gland certification from it.
    """
